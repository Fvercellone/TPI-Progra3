        ...
        <div class="card-header">
            ...
            <div>
                ...
                <asp:Button
                    ...
                    <div class="mb-3">
    <asp:Label Text="Filtrar Por Nombre de Persona" runat="server" />
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="mb-3">
                    ...
                    <asp:TextBox runat="server" ID="txtFiltroAvanzado" CssClass="form-control" AutoPostBack="true" OnTextChanged="filtroAvanzado_TextChanged"/>
                </div>
            </div>
            <div class="col-3">
                <div class="mb-3">
